...
public class str{
  ...
  */
  public static int sToI(String s){
    try {
      ...
      errorConversion("String To long",s);
      return -1;
    }
  }
  /**
  ...
  */
  public static byte iToBy(int x){
    if(x>127){ x=127;errorConversion("int To byte",x+"");}
    if(x<-128){ x=-128;errorConversion("int To byte",x+"");}
    return (byte) x;
  }
  /**
  ...
  */
  public static boolean iToB(int b){
    if (b==0){ return false;}
    if (b==1){ return true;}
    errorConversion("int To Boolean",b+"");
    return true;
  }
  /**
  ...
  *@version 1.1
  */
  public static void errorConversion(String xToY, String s){
    error.error("Impossible to do 1 for the conversions" +" "+ xToY +" : "+s,"str.");
  }
  //tableaux
  /**
  *{@summary From int to String}
